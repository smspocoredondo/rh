...
function imprimirTabela(tabelaId) {
    ...
    novaJanela.document.write('<style>body{font-family: Arial, sans-serif;} table{width: 100%; border-collapse: collapse;} table, th, td{border: 1px solid black; padding: 8px; text-align: left; fonte-size: 12px;} th{background-color: #f2f2f2;}</style>');
